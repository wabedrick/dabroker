...
part of 'property_api_client.dart';
...
class _PropertyApiClient implements PropertyApiClient {
  _PropertyApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PropertyListResponse> fetchProperties(
    ...
    final _options = _setStreamType<PropertyListResponse>(
    ...
    late PropertyListResponse _value;
    try {
      _value = PropertyListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<dynamic> fetchPropertyDetailRaw(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> favoriteProperty(String propertyId) async {
    ...
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/favorites/properties/${propertyId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<dynamic> createPropertyRaw(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> getRoomsRaw(String propertyId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
