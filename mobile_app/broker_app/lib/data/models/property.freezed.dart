...
@JsonKey(fromJson: _requiredStringFromJson) String get id;@JsonKey(fromJson: _requiredStringFromJson) String get title; String? get slug; String? get type; String? get category; String? get status;@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? get price; String? get currency;@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? get size; String? get sizeUnit;@JsonKey(fromJson: _intFromJson, toJson: _intToJson) int? get houseAge; String? get address; String? get city; String? get state; String? get country; String? get postalCode;@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? get latitude;@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? get longitude; List<String>? get amenities;@JsonKey(fromJson: _metadataFromJson) Map<String, dynamic>? get metadata; String? get description; DateTime? get availableFrom; List<Room>? get rooms; PropertyUserSummary? get owner; List<PropertyMedia>? get gallery; bool? get isFavorited; bool? get isAvailable; DateTime? get createdAt; DateTime? get updatedAt; String? get videoUrl; String? get virtualTourUrl; List<Map<String, dynamic>>? get nearbyPlaces; DateTime? get verifiedAt; List<PropertyPriceHistory>? get priceHistory; List<Property>? get similarProperties;@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? get distance;
...
@useResult
$Res call({
@JsonKey(fromJson: _requiredStringFromJson) String id,@JsonKey(fromJson: _requiredStringFromJson) String title, String? slug, String? type, String? category, String? status,@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? price, String? currency,@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? size, String? sizeUnit,@JsonKey(fromJson: _intFromJson, toJson: _intToJson) int? houseAge, String? address, String? city, String? state, String? country, String? postalCode,@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? latitude,@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? longitude, List<String>? amenities,@JsonKey(fromJson: _metadataFromJson) Map<String, dynamic>? metadata, String? description, DateTime? availableFrom, List<Room>? rooms, PropertyUserSummary? owner, List<PropertyMedia>? gallery, bool? isFavorited, bool? isAvailable, DateTime? createdAt, DateTime? updatedAt, String? videoUrl, String? virtualTourUrl, List<Map<String, dynamic>>? nearbyPlaces, DateTime? verifiedAt, List<PropertyPriceHistory>? priceHistory, List<Property>? similarProperties,@JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) double? distance
});
...
as DateTime?,rooms: freezed == rooms ? _self.rooms : rooms // ignore: cast_nullable_to_non_nullable
as List<Room>?,owner: freezed == owner ? _self.owner : owner // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _requiredStringFromJson)  String id, @JsonKey(fromJson: _requiredStringFromJson)  String title,  String? slug,  String? type,  String? category,  String? status, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? price,  String? currency, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? size,  String? sizeUnit, @JsonKey(fromJson: _intFromJson, toJson: _intToJson)  int? houseAge,  String? address,  String? city,  String? state,  String? country,  String? postalCode, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? latitude, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? longitude,  List<String>? amenities, @JsonKey(fromJson: _metadataFromJson)  Map<String, dynamic>? metadata,  String? description,  DateTime? availableFrom,  List<Room>? rooms,  PropertyUserSummary? owner,  List<PropertyMedia>? gallery,  bool? isFavorited,  bool? isAvailable,  DateTime? createdAt,  DateTime? updatedAt,  String? videoUrl,  String? virtualTourUrl,  List<Map<String, dynamic>>? nearbyPlaces,  DateTime? verifiedAt,  List<PropertyPriceHistory>? priceHistory,  List<Property>? similarProperties, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? distance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Property() when $default != null:
return $default(_that.id,_that.title,_that.slug,_that.type,_that.category,_that.status,_that.price,_that.currency,_that.size,_that.sizeUnit,_that.houseAge,_that.address,_that.city,_that.state,_that.country,_that.postalCode,_that.latitude,_that.longitude,_that.amenities,_that.metadata,_that.description,_that.availableFrom,_that.rooms,_that.owner,_that.gallery,_that.isFavorited,_that.isAvailable,_that.createdAt,_that.updatedAt,_that.videoUrl,_that.virtualTourUrl,_that.nearbyPlaces,_that.verifiedAt,_that.priceHistory,_that.similarProperties,_that.distance);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _requiredStringFromJson)  String id, @JsonKey(fromJson: _requiredStringFromJson)  String title,  String? slug,  String? type,  String? category,  String? status, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? price,  String? currency, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? size,  String? sizeUnit, @JsonKey(fromJson: _intFromJson, toJson: _intToJson)  int? houseAge,  String? address,  String? city,  String? state,  String? country,  String? postalCode, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? latitude, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? longitude,  List<String>? amenities, @JsonKey(fromJson: _metadataFromJson)  Map<String, dynamic>? metadata,  String? description,  DateTime? availableFrom,  List<Room>? rooms,  PropertyUserSummary? owner,  List<PropertyMedia>? gallery,  bool? isFavorited,  bool? isAvailable,  DateTime? createdAt,  DateTime? updatedAt,  String? videoUrl,  String? virtualTourUrl,  List<Map<String, dynamic>>? nearbyPlaces,  DateTime? verifiedAt,  List<PropertyPriceHistory>? priceHistory,  List<Property>? similarProperties, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? distance)  $default,) {final _that = this;
switch (_that) {
case _Property():
return $default(_that.id,_that.title,_that.slug,_that.type,_that.category,_that.status,_that.price,_that.currency,_that.size,_that.sizeUnit,_that.houseAge,_that.address,_that.city,_that.state,_that.country,_that.postalCode,_that.latitude,_that.longitude,_that.amenities,_that.metadata,_that.description,_that.availableFrom,_that.rooms,_that.owner,_that.gallery,_that.isFavorited,_that.isAvailable,_that.createdAt,_that.updatedAt,_that.videoUrl,_that.virtualTourUrl,_that.nearbyPlaces,_that.verifiedAt,_that.priceHistory,_that.similarProperties,_that.distance);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: _requiredStringFromJson)  String id, @JsonKey(fromJson: _requiredStringFromJson)  String title,  String? slug,  String? type,  String? category,  String? status, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? price,  String? currency, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? size,  String? sizeUnit, @JsonKey(fromJson: _intFromJson, toJson: _intToJson)  int? houseAge,  String? address,  String? city,  String? state,  String? country,  String? postalCode, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? latitude, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? longitude,  List<String>? amenities, @JsonKey(fromJson: _metadataFromJson)  Map<String, dynamic>? metadata,  String? description,  DateTime? availableFrom,  List<Room>? rooms,  PropertyUserSummary? owner,  List<PropertyMedia>? gallery,  bool? isFavorited,  bool? isAvailable,  DateTime? createdAt,  DateTime? updatedAt,  String? videoUrl,  String? virtualTourUrl,  List<Map<String, dynamic>>? nearbyPlaces,  DateTime? verifiedAt,  List<PropertyPriceHistory>? priceHistory,  List<Property>? similarProperties, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson)  double? distance)?  $default,) {final _that = this;
switch (_that) {
case _Property() when $default != null:
return $default(_that.id,_that.title,_that.slug,_that.type,_that.category,_that.status,_that.price,_that.currency,_that.size,_that.sizeUnit,_that.houseAge,_that.address,_that.city,_that.state,_that.country,_that.postalCode,_that.latitude,_that.longitude,_that.amenities,_that.metadata,_that.description,_that.availableFrom,_that.rooms,_that.owner,_that.gallery,_that.isFavorited,_that.isAvailable,_that.createdAt,_that.updatedAt,_that.videoUrl,_that.virtualTourUrl,_that.nearbyPlaces,_that.verifiedAt,_that.priceHistory,_that.similarProperties,_that.distance);case _:
  return null;
...
class _Property implements Property {
  const _Property({@JsonKey(fromJson: _requiredStringFromJson) required this.id, @JsonKey(fromJson: _requiredStringFromJson) required this.title, this.slug, this.type, this.category, this.status, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) this.price, this.currency, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) this.size, this.sizeUnit, @JsonKey(fromJson: _intFromJson, toJson: _intToJson) this.houseAge, this.address, this.city, this.state, this.country, this.postalCode, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) this.latitude, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) this.longitude, final  List<String>? amenities, @JsonKey(fromJson: _metadataFromJson) final  Map<String, dynamic>? metadata, this.description, this.availableFrom, final  List<Room>? rooms, this.owner, final  List<PropertyMedia>? gallery, this.isFavorited, this.isAvailable, this.createdAt, this.updatedAt, this.videoUrl, this.virtualTourUrl, final  List<Map<String, dynamic>>? nearbyPlaces, this.verifiedAt, final  List<PropertyPriceHistory>? priceHistory, final  List<Property>? similarProperties, @JsonKey(fromJson: _doubleFromJson, toJson: _doubleToJson) this.distance}): _amenities = amenities,_metadata = metadata,_rooms = rooms,_gallery = gallery,_nearbyPlaces = nearbyPlaces,_priceHistory = priceHistory,_similarProperties = similarProperties;
...
@override@JsonKey(fromJson: _requiredStringFromJson) final  String title;
...
as Map<String, dynamic>?,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,availableFrom: freezed == availableFrom ? _self.availableFrom : availableFrom // ignore: cast_nullable_to_non_nullable
as DateTime?,rooms: freezed == rooms ? _self._rooms : rooms // ignore: cast_nullable_to_non_nullable
as List<Room>?,owner: freezed == owner ? _self.owner : owner // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of PropertyMedia
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? caption = freezed,Object? url = freezed,Object? thumbnailUrl = freezed,Object? previewUrl = freezed,}) {
  return _then(_self.copyWith(
...
class _PropertyMedia implements PropertyMedia {
  const _PropertyMedia({this.id, this.name, this.caption, this.url, this.thumbnailUrl, this.previewUrl});
...
/// Create a copy of PropertyMedia
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? caption = freezed,Object? url = freezed,Object? thumbnailUrl = freezed,Object? previewUrl = freezed,}) {
...
/// Create a copy of PropertyUserSummary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? preferredRole = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of PropertyUserSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = freezed,Object? preferredRole = freezed,}) {
