...
_Lodging _$LodgingFromJson(Map<String, dynamic> json) => _Lodging(
  ...
  averageRating: json['average_rating'] == null
      ? 0.0
      : _doubleFromJsonNonNull(json['average_rating']),
  ratingsCount: (json['ratings_count'] as num?)?.toInt() ?? 0,
);

Map<String, dynamic> _$LodgingToJson(_Lodging instance) => <String, dynamic>{
  'id': instance.id,
...
Map<String, dynamic> _$LodgingMediaToJson(_LodgingMedia instance) =>
    <String, dynamic>{
      'id': instance.id,
      'url': instance.url,
